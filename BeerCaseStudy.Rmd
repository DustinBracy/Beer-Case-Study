...
Styles <- mice(Brewdata [c('IPA','Porter','Stout','Lager','Pilsner','Red','Wheat','Amber',
                           'Blonde','Brown','Cider','Ale')], m=5,maxit=50,meth='pmm',seed=100)
...
bbABVper.clean <- BrewdataABVper %>% filter(!is.na(brew.beerABVper$ABVper))
#bbABVper.clean
